...
\begin{frame}
  ...
  \begin{overprint}
    ...
    \codeunderlinex{selectAdults3}
    \codeoverlinex{selectAdults3b}
    \tikz[remember picture,overlay] \draw[thick,red,-latex] let \p1=(selectAdults3b), \p2=(selectAdults3) in (\p1) -- ++(0,0.1) -- ++(2.5,0) |- ($ (\p2) + (0,-0.4) $) -- (\p2);
