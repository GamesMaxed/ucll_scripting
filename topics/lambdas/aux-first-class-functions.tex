...
\begin{frame}
  ...
  \begin{overprint}
    ...
    %   \draw[thick,red,-latex] (selectAdults3 isadult) -- ++(0,1);
    % \end{tikzpicture}
    ...
    % \tikz[remember picture,overlay] \draw[thick,-latex,red] let \p1=(selectAdults4), \p2=(selectAdults4b) in (\p1) -- ++(0,-0.5) |- ($ (\p2) + (0,0.3) $) -- (\p2);
  \end{overprint}
\end{frame}
