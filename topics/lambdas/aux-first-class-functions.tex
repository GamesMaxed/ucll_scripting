...
\begin{frame}
  ...
  \begin{overprint}
    \onslide<1>
    \code[language=python,font=\small]{selectAdults2.py}
    \codeunderline{selectAdults start}{selectAdults end}

    \onslide<2>
    \code[language=python,font=\small]{selectAdults3.py}
    ...
    \onslide<3>
    \code[language=python,font=\small]{selectAdults4.py}
...
\begin{frame}
  ...
  \begin{overprint}
    \onslide<1>
    \code[language=python,font=\small]{getAges2.py}
    \codeoverline{getAges2 start}{getAges2 end}

    \onslide<2>
    \code[language=python,font=\small]{getAges3.py}
    ...
    \onslide<3>
    \code[language=python,font=\small]{getAges4.py}
...
\begin{frame}
  ...
  \end{itemize}
  \code[language=python,font=\small]{first-class-function.py}
\end{frame}
