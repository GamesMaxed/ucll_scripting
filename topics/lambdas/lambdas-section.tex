...
\begin{frame}
  ...
  \begin{itemize}
    \item Opvragen naam: functie \texttt{getName}
    \item Opvragen leeftijd: functie \texttt{getAge}
    \item Opvragen lengte: functie \texttt{getHeight}
    \item Opvragen gewicht: functie \texttt{getWeight}
